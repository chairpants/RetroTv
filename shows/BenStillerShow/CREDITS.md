...
Every episode of *The Ben Stiller Show* this player streams comes from
[a single archive.org item](https://archive.org/details/the-ben-stiller-show-complete-series)
that bundles the complete series as individual files. 13 episodes — its
one and only season (Fox, 1992-93). Deep gratitude to whoever assembled
and uploaded the whole run in one place. Support the Archive:
https://archive.org/donate

*The Ben Stiller Show* is the property of its respective rights holders;
