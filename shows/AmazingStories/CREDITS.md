...
Every episode of *Amazing Stories* (1985) this player streams comes from
[a single archive.org item](https://archive.org/details/amazing-stories-1985-1987-complete-series)
that bundles the complete series as individual files. 45 episodes across 2
seasons (NBC, 1985-87) — Steven Spielberg's anthology series. Deep
gratitude to whoever assembled and uploaded the whole run in one place.
Support the Archive: https://archive.org/donate

*Amazing Stories* is the property of its respective rights holders; this
project streams a publicly hosted recording and hosts no video content
itself. A short standalone intro/trailer file bundled in the same
archive.org item (not a real episode) was left out of the lineup.
