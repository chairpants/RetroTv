...
Every episode of *M\*A\*S\*H* this player streams comes from
[a single archive.org item](https://archive.org/details/mash-complete-series_202511)
that bundles the complete series as individual files, organized into
per-season folders. 251 episodes across 11 seasons (CBS, 1972-83) — the
...
*M\*A\*S\*H* is the property of its respective rights holders; this
