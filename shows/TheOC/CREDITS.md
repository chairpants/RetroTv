...
Every episode of *The O.C.* this player streams comes from
[a single archive.org item](https://archive.org/details/the-o.c./Season+1)
that bundles the complete series as individual files, organized into
per-season folders. 92 episodes across 4 seasons (Fox, 2003-07) — the
...
*The O.C.* is the property of its respective rights holders; this project
