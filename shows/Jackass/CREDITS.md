...
Every episode of *Jackass* this player streams comes from
[a single archive.org item](https://archive.org/details/jackasscompleteseries/Jackass+TV+series) that bundles the complete series as
individual files. 3 seasons, 25 episodes (2000-2002). Files are nested inside a "Jackass TV series" folder within the archive.org item — the player encodes each path segment separately so playback still works. Deep gratitude to whoever assembled and
uploaded the whole run in one place. Support the Archive:
https://archive.org/donate

*Jackass* is the property of its respective rights holders; this
