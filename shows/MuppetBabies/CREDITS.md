...
Every episode of *Muppet Babies* (the 1984 series) this player streams
comes from [a single archive.org item](https://archive.org/details/muppet_babies)
that bundles the complete series as individual files. 107 episodes across
8 seasons (CBS, 1984-91) — the full run, every season parsed clean with no
...
*Muppet Babies* is the property of its respective rights holders; this
